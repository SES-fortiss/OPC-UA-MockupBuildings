...
demandPath_elec2  =   folder_forecasts+"SF1_demand_elec_MEMAP.CSV"
pricePath_gas    =   folder_forecasts+"SF1_gas_price.CSV"
pricePath_elec_buy    =   folder_forecasts+"SF1_elec_price_buy.CSV"
pricePath_elec_sell    =   folder_forecasts+"SF1_elec_price_sell.CSV"
...
(myNodeIDcntr, STOR1_SOC, STOR1_calcSOC, STOR1_setpointChg, STOR1_setpointDisChg, SOCminHOR) = add_Storage(counter, naming,
                                                ...
                                                "SFH1_TS1", Storage, "heat", 0.97, 0.97, 62.94, 0.021, 10, 10, 0.64113)
